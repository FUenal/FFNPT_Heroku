...
install.packages(c('magrittr', 'rvest', 'stringr', 'stringi', 'readxl', 'dplyr', 'maps', 'ggplot2', 'reshape2', 'ggiraph', 'RColorBrewer',
                   'leaflet', 'geojsonio', 'shiny', 'shinydashboard', 'sjmisc', 'lubridate', 'kableExtra', 'gridExtra', 'xlsx', 'shinyjs',
                   'shinyWidgets', 'shinythemes','tidyverse','robotstxt','googlesheets4','gargle','cronR','miniUI','shinyFiles'), 
